...
import 'package:fluttermovieapp/bloc/get_video.dart';
import 'package:fluttermovieapp/model/movie.dart';
import 'package:fluttermovieapp/model/video.dart';
...
class DetailScreen extends StatefulWidget{
 ...
 DetailScreen({Key key, @required this.movie}) : super(key: key);
  @override
  _DetailScreen createState() => _DetailScreen(movie);

}
 class _DetailScreen extends State<DetailScreen>{
  final Movie movie;
  _DetailScreen(this.movie);

  @override
  void initState() {
    super.initState();
    movieVideosBloc..getVideo(movie.id);
  }
