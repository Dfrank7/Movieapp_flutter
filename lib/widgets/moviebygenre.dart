...
class MovieByGenre extends StatefulWidget{
  final int genreId;
  MovieByGenre({Key key, @required this.genreId}): super(key:key);
  @override
  _MovieByGenre createState() => _MovieByGenre(genreId);

}

class _MovieByGenre extends State<MovieByGenre>{
  final int genreId;
  _MovieByGenre(this.genreId);
